...
1. **Veritabanı**: SQLEXPRESS yüklü olmalı
2. **Framework Sürümü**: 4.7.2 veya üzeri gerekli
3. **Visual Studio**: 2015 veya sonrası önerilir
4. **AdminLTE Template**: Responsive tasarım sağlar
5. **Role-Based Authorization**: AdminRoleProvider özel uygulaması vardır

---

## Sistem Gereksinimleri

- Windows OS (SQL Server için)
- .NET Framework 4.7.2+
- Visual Studio 2015+
- SQL Server 2012+
- Minimum 4GB RAM
